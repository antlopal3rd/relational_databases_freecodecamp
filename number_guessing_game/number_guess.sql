...
DROP DATABASE namnum;
--
-- Name: namnum; Type: DATABASE; Schema: -; Owner: freecodecamp
--

CREATE DATABASE namnum WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'C.UTF-8' LC_CTYPE = 'C.UTF-8';


ALTER DATABASE namnum OWNER TO freecodecamp;
